...
public class MicroBenchMyBST {
    ...
    static class MyBSTKV implements KV {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Using MyBST with snapshot support
        KV ds = new MyBSTKV();
        ...
        System.out.printf("MyBST: Threads=%d, Time=%ds, TotalOps=%d, Throughput=%.2f Mops/s%n",
